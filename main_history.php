...
<body>
    ...
    <input type="hidden" name="batch_num" id="batch_num" value="1">
    <main class="container-fluid d-flex h-100 flex-column">
        <div class="row flex-grow-1">
            ...
            <div class="col-md-3" style="overflow-x: hidden;overflow-y: auto;">
                <br>
                <span class="status" id="status">ON</span>
                <span class="content">
                    <div class="row">
                        <div class="col-md-8">
                            <span id="info"></span>
                ...
                <button onClick="getBatch()" class="btn btn-warning">End Simulation</button>
            </div>
        </div>     
    </main>

    <script type="text/javascript" src="simulation_history.js"></script>

    <!-- Async script executes immediately and must be after any DOM elements used in callback. -->
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD7UeY754uJ9BcqDh8ARv7NOCwu5EtVXMQ&callback=initMap&libraries=&v=weekly" async></script> 